...
#include <react/renderer/components/AgoraRtcNgSpec/ComponentDescriptors.h>
#include <ChatSdk.h>
...
auto module_AgoraRtcNgSpec = AgoraRtcNgSpec_ModuleProvider(moduleName, params);
if (module_AgoraRtcNgSpec != nullptr) {
return module_AgoraRtcNgSpec;
}
auto module_ChatSdk = ChatSdk_ModuleProvider(moduleName, params);
if (module_ChatSdk != nullptr) {
return module_ChatSdk;
}
...
auto module_RNOtaHotUpdateSpec = RNOtaHotUpdateSpec_ModuleProvider(moduleName, params);
if (module_RNOtaHotUpdateSpec != nullptr) {
return module_RNOtaHotUpdateSpec;
}
...
providerRegistry->add(concreteComponentDescriptorProvider<AgoraRtcSurfaceViewComponentDescriptor>());
providerRegistry->add(concreteComponentDescriptorProvider<AgoraRtcTextureViewComponentDescriptor>());
